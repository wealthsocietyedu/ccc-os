...
const studioRoutes = require('./routes/aistudio');
...
app.use('/api/ai-studio',     authenticate, studioRoutes);
...
app.use('/api/video-downloader', authenticate, videoDownloaderRoutes);
